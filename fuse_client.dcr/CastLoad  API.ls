...
on startCastLoad tCastlibs, tPermanentOrNot
  return getCastLoadManager().startCastLoad(tCastlibs, tPermanentOrNot)
end

on AddCastLoad tCastlibs, tPermanentOrNot
  return getCastLoadManager().startCastLoad(tCastlibs, tPermanentOrNot, 1)
end
