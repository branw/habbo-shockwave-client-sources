...
on getDownloadProperty tPropID
  return getDownloadManager().getProperty(tPropID)
end

on setDownloadProperty tPropID, tValue
  return getDownloadManager().setProperty(tPropID, tValue)
end
