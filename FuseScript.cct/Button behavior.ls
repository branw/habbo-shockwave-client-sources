...
on getPropertyDescriptionList me
  pList = [:]
  addProp(pList, #sEnableText, [#format: #string, #default: EMPTY, #comment: "Help text when enabled"])
  addProp(pList, #sDisableText, [#format: #string, #default: EMPTY, #comment: "Help text when disabled"])
