property ancestor, myswitchON, flameFrame, doFlame
...
on exitFrame me
  ...
  if myswitchON and doFlame mod 5 = 1 then
    if flameFrame > 2 then
      flameFrame = 0
    end if
    flameFrame = flameFrame + 1
    newMName = char 1 to mname.length - 1 of mname & flameFrame
