...
on exitFrame me
  ...
  mName3 = me.lSprites[4].member.name
  if myswitchON then
    ...
    if myswitchON = 0 then
      ...
      me.lSprites[4].locZ = me.lSprites[3].locZ + 1
      if getmemnum(newMName) > 0 then
        me.lSprites[2].castNum = getmemnum(newMName)
        me.lSprites[3].castNum = getmemnum(newMName2)
        me.lSprites[4].castNum = getmemnum(newMName3)
